...
export const PRODUCTS: Product[] = [
  {
    ...
    image: IMAGES.patitaHero,
    gallery: [
      { url: IMAGES.patitaHero, label: 'Ramo Individual', thumb: IMAGES.galleryV1Thumb },
...
export const LIMA_DISTRICTS: LimaDistrictOption[] = [
  { name: 'Miraflores', zone: 'Lima Centro / Sur', fee: 10, estimatedHours: '1 a 2 horas (Mismo día)' },
  { name: 'San Isidro', zone: 'Lima Centro / Financiero', fee: 10, estimatedHours: '1 a 2 horas' },
  { name: 'Santiago de Surco', zone: 'Lima Sur', fee: 10, estimatedHours: '1 a 2 horas' },
  { name: 'San Borja', zone: 'Lima Centro', fee: 10, estimatedHours: '1 a 2 horas' },
  { name: 'Barranco', zone: 'Lima Sur', fee: 10, estimatedHours: '1 a 2 horas' },
  { name: 'Jesús María', zone: 'Lima Centro', fee: 10, estimatedHours: '1 a 2 horas' },
  { name: 'Lince', zone: 'Lima Centro', fee: 10, estimatedHours: '1 a 2 horas' },
  { name: 'Magdalena del Mar', zone: 'Lima Centro', fee: 10, estimatedHours: '1 a 2 horas' },
  { name: 'Pueblo Libre', zone: 'Lima Centro', fee: 10, estimatedHours: '1 a 2 horas' },
  { name: 'San Miguel', zone: 'Lima Centro / Costa', fee: 12, estimatedHours: '2 a 3 horas' },
  { name: 'La Molina', zone: 'Lima Este', fee: 12, estimatedHours: '2 a 3 horas' },
  { name: 'Surquillo', zone: 'Lima Centro', fee: 10, estimatedHours: '1 a 2 horas' },
  { name: 'Cercado de Lima', zone: 'Lima Centro Histórico', fee: 12, estimatedHours: '2 a 3 horas' },
  { name: 'Chorrillos', zone: 'Lima Sur', fee: 12, estimatedHours: '2 a 3 horas' },
  { name: 'Los Olivos', zone: 'Lima Norte', fee: 15, estimatedHours: 'Entrega programada' },
  { name: 'San Martín de Porres', zone: 'Lima Norte', fee: 15, estimatedHours: 'Entrega programada' },
  { name: 'San Juan de Miraflores', zone: 'Lima Sur', fee: 14, estimatedHours: 'Entrega programada' },
  { name: 'San Juan de Lurigancho', zone: 'Lima Este', fee: 16, estimatedHours: 'Entrega programada' },
  { name: 'Ate / Vitarte', zone: 'Lima Este', fee: 15, estimatedHours: 'Entrega programada' },
  { name: 'Comas', zone: 'Lima Norte', fee: 16, estimatedHours: 'Entrega programada' },
  { name: 'Callao / Bellavista', zone: 'Prov. Constitucional', fee: 15, estimatedHours: 'Entrega programada' },
];
